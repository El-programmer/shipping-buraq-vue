<template>
  ...
  >
    ...
    <div
      ...
      data-kt-menu="true"
    >
      <template v-for="(item, i) in MainMenuConfig.MenuConfig" :key="i">
            ...
            >
              <template v-for="(item2, k) in menuItem.sub" :key="k">
                <div v-if="item2.heading" class="menu-item">
                  <router-link
                      v-if="item2.permission && can(item2.permission)"
                  ...
                  >
                    <template v-for="(item3, k) in item2.sub" :key="k">
                      <div v-if="item3.heading" class="menu-item">
                        <router-link
                            v-if="item3.permission && can(item3.permission)"
