  ...
  >
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
      ...
      <a href="#" v-if="asideTheme === 'dark'">
        <img alt="Logo" :src="setting.getVal('head_logo_white')" class="h-75px logo" />
      </a>
      <a href="#" v-if="asideTheme === 'light'">
        <img alt="Logo" :src="setting.getVal('head_logo_colored')" class="h-75px logo" />
      </a>
      <!--end::Logo-->
...
import KTMenu from "@/layout1/aside/Menu.vue";
