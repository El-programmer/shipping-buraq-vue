    ...
    >
      ...
      <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
        <a href="#" class="d-lg-none">
          <img alt="Logo" :src="settings.getVal('head_logo_colored')" class="h-30px" />
        </a>
      </div>
      <!--end::Mobile logo-->
...
import KTTopbar from "@/layout1/header/Topbar.vue";
import KTMenu from "@/layout1/header/Menu.vue";
...
import setting from "@/views/admin/emp/setting.vue";
