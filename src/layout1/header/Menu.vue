<template>
  ...
  >
    ...
    <div
      ...
      data-kt-menu="true"
    >
      <template v-for="(item, i) in MainMenuConfig.MenuHeader" :key="i">
                  ...
                  <template v-for="(menuItem1, k) in menuItem.sub" :key="k">
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <div class="menu-item"
                               v-if="menuItem2.permission && can(menuItem.permission)"
                          >
                            <router-link
                              class="menu-link py-3"
                              active-class="active"
                    ...
                    <div v-if="menuItem1.heading" class="menu-item">
                      <router-link class="menu-link py-3" :to="menuItem1.route"
                                   v-if="menuItem1.permission && can(menuItem1.permission)"
                      >
                        <span class="menu-bullet">
                          <span class="bullet bullet-dot"></span>
                        </span>
