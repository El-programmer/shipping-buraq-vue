...
export const langs = computed(() => {
  return {
    ar: { name: "Arabic", flag: "/media/flags/saudi-arabia.svg" },
    en: { name: "English", flag: "/media/flags/united-states.svg" },
  };
});
...
export const Settings = computed(() => {
  return (
    ...
    '{ "brand": "Logistic","appTimezone": "AFRICA/CAIRO",  "head_logo_white": "/media/logos/logo-5.png", "head_logo_colored": "logo-5.png", "site_main_image": "pattern-1.jpg"}'
  );
});
