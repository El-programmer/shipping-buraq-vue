    ...
    >
      ...
      <template v-if="!isAuth">
        <div class="menu-item menu-lg-down-accordion me-lg-1">
          <router-link :to="{ name: 'site-sign-in' }">
            <a class="menu-link py-3">
              <span class="menu-title">{{ $t("signIn") }}</span>
            </a>
          </router-link>
        </div>
      </template>
      <template v-else>
        <div class="menu-item menu-lg-down-accordion me-lg-1">
          <router-link :to="{ name: 'custemer-orders' }">
            <a class="menu-link py-3">
              <span class="menu-title">
                {{ $t("myOrders") }}
              </span>
...
import MainMenuConfig from "@/core/site/config/MainMenuConfig";
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      isAuth: JwtService.isCustomer() === true ? true : false,
    };
  },
  methods: {
