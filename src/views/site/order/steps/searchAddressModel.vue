          ...
          >
            ...
            <div class="py-5">
              ...
              <div data-kt-search-element="suggestions">
                <!--begin::Heading-->
                <h3 class="fw-bold mb-5">{{ $t('searche') }}:</h3>
                <!--end::Heading-->
                <!--begin::Users-->
                <div
...
export default {
  name: "searchAddressModel",
  props: ['sercheMode', 'addresses', 'divId'],
  data() {
    return {
      currentAddress: {},
    }
  ...
  methods: {
    ...
    setAddress(address) {
      let key = "sender_";
      if (this.$parent.sercheMode == 2) {
        key = 'receiver_';
      }
      this.$parent.setAddress(address, this.$parent.sercheMode)
