              ...
              <div class="card-body pt-0">
                <div class="collapse d-none">
                  <div class="col-12 col-md-4 fv-row fv-plugins-icon-container">
                    ...
                    <!--begin::Input-->
                    <el-date-picker
                      v-model="apiTransaction.filters.start_date"
                      :disabled="loading"
                      format="YYYY/MM/DD"
                      placeholder="Pick a Date"
                      type="date"
                  ...
                  <div class="col-12 col-md-4 fv-row fv-plugins-icon-container">
                    ...
                    <!--begin::Input-->
                    <el-date-picker
                      v-model="apiTransaction.filters.end_date"
                      :disabled="loading"
                      format="YYYY/MM/DD"
                      placeholder="Pick a Date"
                      type="date"
                  ...
                  <div class="col-12 col-md-4 fv-row fv-plugins-icon-container">
                    ...
                    <!--end::Label-->
                    <button
                      :disabled="apiTransaction.loading"
                      class="btn btn-lg btn-primary"
                      @click="apiTransaction.getList(1)"
                    >
                      <span v-if="!apiTransaction.loading">
                        {{ $t("submit") }}
                      </span>
                      <span v-if="apiTransaction.loading">
                        <span
                ...
                <transactions :transactions="apiTransaction.list"></transactions>
                <pagnation
                  v-model:pageNumber="apiTransaction.filters.page"
                  :page="apiTransaction.allData"
                  @change="apiTransaction.getList(apiTransaction.filters.page)"
                ></pagnation>
              </div>
              <!--end::Card body-->
            </div>
...
import Transactions from "@/views/admin/clients/transactions.vue";
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      charageForm:{},
      ordersPage:{},
      apiTransaction:useTransaction()
    };
  },
  async created() {
    this.filters.customer_id = this.$route.params.customer;
    ApiService.query(
      "admin/customers/" + this.$route.params.customer,
      this.filters
    ).then((res) => {
    ...
    this.apiTransaction.setUrl('/admin/customers/'+this.$route.params.customer+'/transactions');
    this.apiTransaction.getList();
