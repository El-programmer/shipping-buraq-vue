<template>
  <div id="kt_content" class="content flex-row-fluid">
          ...
          <div class="card-header">
            ...
            <div class="card-toolbar">
              <a
                ...
                data-bs-target="#kt_modal_Shipment_Container_"
              ...
              <div class="table-responsive">
                ...
                >
                  ...
                  <tbody class="fw-bold text-gray-800">
                    <tr v-for="(item, i) in tableDataTypesFilter" :key="i">
                      <td>
    ...
    <div
      id="kt_modal_Shipment_Container_"
      ref="my-modal"
      aria-hidden="true"
      class="modal fade"
      tabindex="-1"
    ...
    async submitModelForm() {
      ...
      if (this.isEditType > -1) {
        await ApiService.put(
          "admin/shipments/types/ShipmentContainer/" + this.tableDataTypes[this.isEditType].id,
          this.TypeForm
        )
          .then((res) => {
            hideModal("kt_modal_Shipment_Container_");
        ...
        await ApiService.post("admin/shipments/types/ShipmentContainer", this.TypeForm)
          .then((res) => {
            if (res.data.data) {
              this.$toast.success(this.$t("messages.success"));
