        ...
        <div class="card card-flush pt-3 mb-5 mb-xl-10">
          ...
          <div class="card-header">
            ...
            <div class="card-title">
              <h2 class="fw-bolder">{{ $t("Discussion types") }}</h2>
            </div>
            <!--begin::Card title-->
            <!--begin::Card toolbar-->
            ...
            <div class="modal-body py-10 px-lg-17">
              ...
              >
                ...
                <div class="fv-row mb-7">
                  ...
                  <el-form-item prop="name">
                    <el-input v-model="TypeForm.replay" type="text" />
                  </el-form-item>
                  <span v-if="TypeErrors['replay']" class="text-danger">{{
                    TypeErrors["replay"][0]
                  }}</span>
                </div>
              </div>
...
export default defineComponent({
  ...
  created() {
    ApiService.get("admin/DiscussionTypes").then((data) => {
      this.tableData = data.data.data;
      this.loading = false;
    });
  },
  mounted() {
    setCurrentPageBreadcrumbs(this.$t("Discussion types"), [this.$t("cp")]);
  },
  methods: {
    openModelTypeNew() {
      this.isEditType = -1;
    ...
    async submitModelForm() {
      ...
      if (this.isEditType > -1) {
        await ApiService.put(
          "admin/DiscussionTypes/" + this.tableData[this.isEditType].id,
          this.TypeForm
        )
          .then((res) => {
        ...
        await ApiService.post("admin/DiscussionTypes", this.TypeForm)
          .then((res) => {
            if (res.data.data) {
              this.$toast.success(this.$t("messages.success"));
    ...
    async deleteType(i) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ApiService.delete(
            "admin/DiscussionTypes/" + this.tableData[i].id
          ).then((res) => {
