<template>
  <div class="card card-flush pt-3 mb-5 mb-xl-10">
    ...
    <div class="card-header">
      ...
      <div class="card-title">
        <h2 class="fw-bolder">{{ $t("Service Numbers") }}</h2>
      </div>
      <!--begin::Card title-->
      <!--begin::Card toolbar-->
      <div class="card-toolbar">
        <a
            ...
            data-bs-target="#kt_modal_service_number_discount"
  ...
  <div
      id="kt_modal_service_number_discount"
      ref="my-modal"
      aria-hidden="true"
      class="modal fade"
      tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        ...
        <div id="kt_modal_add_Country_header" class="modal-header">
          ...
          <!--begin::Close-->
          <div
              id="kt_modal_service_number_discount_close"
              ...
              <div class="row">
                <div class="col-12 col-md-6">
                  ...
                  <el-form-item prop="start">
                    <el-input v-model="TypeForm.start" type="start"/>
                  </el-form-item>
                  <span v-if="Errors['start']" class="text-danger">{{
                    Errors["start"][0]
                  }}</span>
                </div>
                <div class="col-12 col-md-6">
                  ...
                  <el-form-item prop="end">
                    <el-input v-model="TypeForm.end" type="end"/>
                  </el-form-item>
                  <span v-if="Errors['end']" class="text-danger">{{
                    Errors["end"][0]
                  }}</span>
                </div>
                <div class="col-12">
                  ...
                  <el-form-item prop="discount">
                    <el-input v-model="TypeForm.discount" type="number"/>
                  </el-form-item>
                  <span v-if="Errors['discount']" class="text-danger">{{
                    Errors["discount"][0]
                  }}</span>
                </div>
              </div>
...
export default {
  ...
  beforeCreate() {
    ApiService.get("admin/service/number/" + this.serviceId).then((data) => {
    ...
    async submitModelForm() {
      ...
      if (this.isEditType > -1) {
        await ApiService.put(
            `admin/service/number/${this.serviceId}/` +
            this.tableDataTypes[this.isEditType].id,
            this.TypeForm
        )
            .then((res) => {
              hideModal("kt_modal_service_number_discount");
