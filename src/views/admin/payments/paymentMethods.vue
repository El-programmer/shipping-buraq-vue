        ...
        <div class="card card-flush pt-3 mb-5 mb-xl-10">
          ...
          <div class="card-header">
            ...
            <div class="card-title">
              <h2 class="fw-bolder">Pyment Methods</h2>
            </div>
            <!--begin::Card title-->
            <!--begin::Card toolbar-->
      ...
      <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
          ...
          <div id="kt_modal_add_Country_header" class="modal-header">
            <!--begin::Modal title-->
            <h2 v-if="isEdit > -1" class="fw-bolder">Edit a Payment</h2>
            <h2 v-else class="fw-bolder">Add New Payment</h2>
            <!--end::Modal title-->
          ...
          <el-form @submit.prevent="submitModelForm()">
            ...
            <div class="modal-body py-10 px-lg-17">
              ...
              >
                ...
                <div class="fv-row mb-7">
                  <label class="required fs-6 fw-bold mb-2">module </label>
                  <el-form-item prop="name">
                    <el-input v-model="ItemForm.module" type="text"/>
                  </el-form-item>
                  <span v-if="errors['module']" class="text-danger">{{
                    errors["module"][0]
                  }}</span>
                </div>
                ...
                <div class="d-flex flex-column mb-7 fv-row">
                  ...
                  <el-select v-model="ItemForm.mode">
                    <el-option value="1">Live</el-option>
                    <el-option value="0">SandBox</el-option>
                  </el-select>
                </div>

                <div class="fv-row mb-7">
                  <label class="required fs-6 fw-bold mb-2">live user </label>
                  <el-form-item prop="name">
                    <el-input v-model="ItemForm.live_user" type="text"/>
                  </el-form-item>
                  <span v-if="errors['live_user']" class="text-danger">{{
                    errors["live_user"][0]
                  }}</span>
                </div>
                <div class="fv-row mb-7">
                  <label class="required fs-6 fw-bold mb-2">live secret </label>
                  <el-form-item prop="name">
                    <el-input v-model="ItemForm.live_secret" type="text"/>
                  </el-form-item>
                  <span v-if="errors['live_secret']" class="text-danger">{{
                    errors["live_secret"][0]
                  }}</span>
                </div>

                <div class="fv-row mb-7">
                  <label class="required fs-6 fw-bold mb-2">sandboxuser </label>
                  <el-form-item prop="name">
                    <el-input v-model="ItemForm.sandbox_user" type="text"/>
                  </el-form-item>
                  <span v-if="errors['sandbox_user']" class="text-danger">{{
                    errors["sandbox_user"][0]
                  }}</span>
                </div>
                <div class="fv-row mb-7">
                  ...
                  <span v-if="errors['sandbox_secret']" class="text-danger">{{
                    errors["sandbox_secret"][0]
                  }}</span>
                </div>
...
export default defineComponent({
  ...
  created() {
    let res = ApiService.get("admin/PaymentMethods").then((data) => {
      this.tableDataItems = data.data.data;
    });
  },
  mounted() {
    setCurrentPageBreadcrumbs(this.$t("Payment Methods"), [
      this.$t("cp"),
      this.$t("Payment Methods"),
    ]);
  },
  methods: {
    openModelNew() {
